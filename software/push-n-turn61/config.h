...
__code uint8_t DevDesc[] = {    
    ...
    0x09,0x12,0xC1,0xCA, /* VID PID bString (see https://pid.codes/1209/CAC1/)*/
...
__code uint8_t Prod_Des[]={                                // Produce String Descriptor
    0x1A,0x03,'P',0x00,'u',0x00,'s',0x00,'h',0x00,'&',0x00,'T',0x00,'u',0x00,'r',0x00,'n',0x00,'-',0x00,'6',0x00,'1',0x00};
